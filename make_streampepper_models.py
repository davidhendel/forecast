...
pal5_stars_per_tail = {'cfht':4400} #Ibata et al. 2016, adjusted for the 10sigma mag limit
...
pal5_config = streammodel_util.stream_config(obs=pal5obs, age=pal5age, sigv=pal5sigv, 
                            ...
                            ntimes='64sampling', name=pal5name, nstars=pal5_stars_per_tail)
...
gd1R_name = 'gd1_coord'
gd1_stars_per_tail = {'all':13000} #de Boer et al. 2020, .1-120 Msun, assuming half & half leading/trailing

gd1_config = streammodel_util.stream_config(obs=gd1obs, age=gd1age, sigv=gd1sigv, 
                            R=gd1R, R_coord=gd1R_coord, R_name=gd1R_name, 
                            ntimes='64sampling',name=gd1name, nstars=gd1_stars_per_tail)
